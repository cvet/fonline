...
let GitHistoryCommandHandler = class GitHistoryCommandHandler {
    ...
    viewHistory(fileUri, lineNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gitService = yield this.serviceContainer.get(types_6.IGitServiceFactory)
            ...
            yield this.serviceContainer.get(types_5.IWorkspaceQueryStateStore)
                .initialize(id, workspaceFolder, gitRoot, branchName, types_6.BranchSelection.Current, '', fileUri, lineNumber);
            const queryArgs = [
                `id=${id}`,
