...
const gitTagRemove_1 = require("./commit/gitTagRemove");
...
function registerTypes(serviceManager) {
    ...
    serviceManager.addSingleton(types_1.IGitTagRemoveCommandHandler, gitTagRemove_1.GitTagRemoveCommandHandler);
