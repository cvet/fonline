...
if(FO_ANGELSCRIPT_SCRIPTING)
    ...
    list(APPEND FO_COMMON_CORE_LIBS AngelScriptScripting)
endif()
...
if(FO_BUILD_COMMON_LIB)
    ...
    list(APPEND FO_COMMON_CORE_LIBS CommonLib)
    
    if(FO_ANGELSCRIPT_SCRIPTING)
        target_include_directories(CommonLib PUBLIC "${FO_ANGELSCRIPT_SCRIPTING_DIR}")
        target_link_libraries(AngelScriptScripting CommonLib)
    endif()
endif()
...
if(FO_BUILD_CLIENT_LIB)
    ...
    target_link_libraries(ClientLib ${FO_COMMON_CORE_LIBS} ${FO_CLIENT_SYSTEM_LIBS} ${FO_CLIENT_LIBS})
...
if(FO_BUILD_SERVER_LIB)
    ...
    target_link_libraries(ServerLib ${FO_COMMON_CORE_LIBS} ${FO_SERVER_SYSTEM_LIBS} ${FO_SERVER_LIBS})
...
if(FO_BUILD_MAPPER_LIB)
    ...
    target_link_libraries(MapperLib ClientLib ${FO_COMMON_CORE_LIBS})
...
if(FO_BUILD_BAKER_LIB)
    ...
    target_link_libraries(BakerLib ${FO_COMMON_CORE_LIBS} ${FO_BAKER_SYSTEM_LIBS} ${FO_BAKER_LIBS})
...
if(FO_BUILD_EDITOR_LIB)
    ...
    target_link_libraries(EditorLib BakerLib ${FO_COMMON_CORE_LIBS})
...
if(FO_BUILD_CLIENT)
    if(NOT FO_BUILD_LIBRARY)
        ...
        set_target_properties(${FO_DEV_NAME}_Client PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_CLIENT_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
    else()
...
if(FO_BUILD_SERVER)
    ...
    set_target_properties(${FO_DEV_NAME}_Server PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_SERVER_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
    ...
    set_target_properties(${FO_DEV_NAME}_ServerHeadless PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_SERVER_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
    ...
    if(FO_WINDOWS)
        ...
        set_target_properties(${FO_DEV_NAME}_ServerService PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_SERVER_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
        ...
        set_target_properties(${FO_DEV_NAME}_ServerDaemon PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_SERVER_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
...
if(FO_BUILD_EDITOR)
    ...
    set_target_properties(${FO_DEV_NAME}_Editor PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_EDITOR_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
...
if(FO_BUILD_MAPPER)
    ...
    set_target_properties(${FO_DEV_NAME}_Mapper PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_MAPPER_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
...
if(FO_BUILD_ASCOMPILER)
    ...
    set_target_properties(${FO_DEV_NAME}_ASCompiler PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_ASCOMPILER_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
...
if(FO_BUILD_BAKER)
    ...
    set_target_properties(${FO_DEV_NAME}_Baker PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_BAKER_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_OUTPUT_PATH})
...
if(FO_UNIT_TESTS OR FO_CODE_COVERAGE)
    macro(SetupTestBuild name)
        ...
        set_target_properties(${target} PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${FO_TESTS_OUTPUT} DEBUGGER_WORKING_DIRECTORY ${FO_TESTS_OUTPUT})
