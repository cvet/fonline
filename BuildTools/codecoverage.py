...
<head>
  <meta charset="utf-8">
  <title>Last Frontier Engine Coverage</title>
  <style>
    :root {{
      color-scheme: light;
      --bg: #f5f3ec;
...
<body>
  <main>
    <section class="hero">
      <h1>Last Frontier Engine Coverage</h1>
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run and analyze Last Frontier engine code coverage")
