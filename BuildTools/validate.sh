...
if [ "$1" = "linux-client" ]; then
    TARGET=linux
    BUILD_TARGET="-DFO_BUILD_CLIENT=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
    ...
    TARGET=linux
    BUILD_TARGET="-DFO_BUILD_SERVER=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
    ...
    TARGET=linux
    BUILD_TARGET="-DFO_BUILD_SINGLE=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
    ...
    TARGET=linux
    BUILD_TARGET="-DFO_BUILD_EDITOR=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
    ...
    TARGET=linux
    BUILD_TARGET="-DFO_BUILD_MAPPER=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
    ...
    TARGET=linux
    BUILD_TARGET="-DFO_BUILD_ASCOMPILER=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
    ...
    TARGET=linux
    BUILD_TARGET="-DFO_BUILD_BAKER=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
    ...
    TARGET=linux
    BUILD_TARGET="-DFO_UNIT_TESTS=1 -DCMAKE_BUILD_TYPE=Debug"
elif [ "$1" = "code-coverage" ]; then
    TARGET=linux
    USE_GCC=1
    BUILD_TARGET="-DFO_CODE_COVERAGE=1 -DFO_UNIT_TESTS=0 -DCMAKE_BUILD_TYPE=Debug"
else
