...
- Use `FO_STACK_TRACE_ENTRY()` or `FO_NO_STACK_TRACE_ENTRY()` only in `.cpp` method/function bodies. Do not put either stack-trace macro in headers, inline header-defined bodies, or lambda bodies.
