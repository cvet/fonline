...
// (FOnline Patch) The headless project compiler does not vendor unused IronPython scripting dependencies.
...
namespace Effekseer.Data.Value
{
	public class IntWithInifinite : IResettableValue, IValueChangedFromDefault
	{
		...
		{
			add { Value.OnChanged += value; Infinite.OnChanged += value; }
			remove { Value.OnChanged -= value; Infinite.OnChanged -= value; }
		}
