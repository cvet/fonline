...
namespace Effekseer.Data.Value
{
	public class Vector4D : IResettableValue, IValueChangedFromDefault
	{
		...
		{
			add { X.OnChanged += value; Y.OnChanged += value; Z.OnChanged += value; W.OnChanged += value; }
			remove { X.OnChanged -= value; Y.OnChanged -= value; Z.OnChanged -= value; W.OnChanged -= value; }
		}
