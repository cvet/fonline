...
namespace Effekseer
{
	public class LanguageTable
	{
		...
		{
			// (FOnline Patch) Stale upstream option files may name a pruned language.
			var language = languages.Select((i, v) => Tuple35.Create(i, v)).FirstOrDefault(_ => _.Item1 == key);
			var ind = language != null ? language.Item2 : 0;
