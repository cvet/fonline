...
namespace Effekseer.Utils
{
	...
	public class MaterialInformation
	{
...
#if FONLINE_HEADLESS
		// (FOnline Patch) The resource baker preserves editor-only JSON without taking an editor dependency.
		public string EditorData = null;
#else
		...
		public byte[] SaveToBytes()
		{
			...
			{
#if FONLINE_HEADLESS
				string jsonText = EditorData ?? "null";
#else
