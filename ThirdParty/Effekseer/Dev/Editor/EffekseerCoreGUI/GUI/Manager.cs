...
namespace Effekseer.GUI
{
	...
	{
		const string BundledFontPath = "resources/fonts/FOnlineEffekseerLatin-Regular.otf";
		...
		private static void ReloadFonts()
		{
			...
			var fontPath = System.IO.Path.Combine(appDirectory, BundledFontPath);
			...
			NativeManager.AddFontFromFileTTF(fontPath, string.Empty, "en", fontSize);
