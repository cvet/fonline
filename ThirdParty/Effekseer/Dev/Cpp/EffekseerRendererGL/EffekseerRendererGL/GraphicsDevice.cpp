...
void GraphicsDevice::Draw(const Effekseer::Backend::DrawParameter& drawParam)
{
	...
	{
		GLExt::glDrawElementsInstanced(primitiveMode,
								 indexPerPrimitive * drawParam.PrimitiveCount,
								 indexStrideType,
								 reinterpret_cast<void*>(static_cast<intptr_t>(drawParam.IndexOffset * indexStride)),
...
#if !defined(__EMSCRIPTEN__) && !defined(__EFFEKSEER_RENDERER_GLES2__) && !defined(__EFFEKSEER_RENDERER_GL2__) && !defined(__EFFEKSEER_RENDERER_GLES3__)
