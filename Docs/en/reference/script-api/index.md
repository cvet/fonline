...
| [Engine settings](settings.md) | 281 | Fixed and runtime-variable engine settings. |
...
| Signal | Count |
| --- | --- |
| Addressable symbols | 2498 |
| Symbols with descriptions | 2498 |
...
| Label | Symbols |
| --- | --- |
| <code>experimental</code> | 2497 |
| <code>internal</code> | 1 |

## Scope contract

The complete current inventory is <code>experimental</code> since <code>2022.1.0.wip</code>. The declaration pins 2498 stable IDs with SHA-256 <code>622aadc0a8b8d904f7d8de7b7af24eaf34c8cd6218cb8427469f57badc161d0b</code>; any symbol addition, removal, or stable-ID change fails generation until an owner reviews and updates both pins.
