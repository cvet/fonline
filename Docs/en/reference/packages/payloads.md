...
| --- | --- | --- | --- |
| <a id="entry-package-payload-windows-6b9618ed08"></a><code>package.payload.Windows</code> | <code>Windows</code> | <code>implemented</code> | Patched PE executable or DLL, companion runtime files, PDBs when present, and resource ZIP directories unless NoRes is selected. Managed builds carry target-specific managed assemblies and the prepared runtime inside the selected resource pack. win32-win7 and win64-win7 read the canonical win32/win64 binary entry selected by the same per-binary POSTFIX. |
| <a id="entry-package-payload-linux-92e6941cc5"></a><code>package.payload.Linux</code> | <code>Linux</code> | <code>implemented</code> | Patched executable or shared runtime, companion files, and resource ZIP directories unless NoRes is selected. Managed builds carry target-specific managed assemblies and the prepared runtime inside the selected resource pack. |
| <a id="entry-package-payload-android-094c0cd541"></a><code>package.payload.Android</code> | <code>Android</code> | <code>implemented</code> | Generated Gradle project containing libmain.so per ABI and baked resources under app assets; managed assemblies and the prepared runtime remain in the resource-pack assets. Apk optionally emits a sibling APK. |
| <a id="entry-package-payload-web-04b1334012"></a><code>package.payload.Web</code> | <code>Web</code> | <code>implemented</code> | JavaScript, patched Wasm, HTML shell, Resources.data/Resources.js preload files, target-specific managed assemblies and runtime resources when enabled, and an optional local server helper. |
