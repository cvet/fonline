...
[Native extension reference](../../reference/native-extension/index.md) is the exact reference for project-native source roles, supported engine hooks, generated fallbacks, and native binding rules. `BuildTools/NativeExtensionInterface.json` is consumed by CMake and `BuildTools/codegen.py`; `BuildTools/docs_native_extension.py` validates those runtime consumers and emits [generated/native-extension.json](../../../generated/native-extension.json) plus role, hook, and binding pages.
