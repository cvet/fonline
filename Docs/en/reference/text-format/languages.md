...
| <a id="entry-text-format-language-identifier-ce551dd6b3"></a><code>text-format.language.identifier</code> | Language identifier | The Engine treats the filename suffix as an opaque configured string and imposes no fixed character count. | Acceptance is equality against the language names parsed from Baking.BakeLanguages; no length or locale-shape validator exists. | [Source/Tools/TextBaker.cpp](https://github.com/cvet/fonline/blob/master/Source/Tools/TextBaker.cpp) |
| <a id="entry-text-format-language-base-c0360baaa0"></a><code>text-format.language.base</code> | Base language | Baking.BakeLanguages must be non-empty and its first bare language is the default normalization base. | TextPack::ParseBakeLanguages validates the ordered declarations before either text baker consumes them. | [Source/Tools/TextBaker.cpp](https://github.com/cvet/fonline/blob/master/Source/Tools/TextBaker.cpp), [Source/Common/TextPack.cpp](https://github.com/cvet/fonline/blob/master/Source/Common/TextPack.cpp) |
| <a id="entry-text-format-language-fallback-declaration-48971fa338"></a><code>text-format.language.fallback-declaration</code> | Fallback declaration | Each BakeLanguages entry is language or child:parent; names are unique and a parent must appear before its child. | An explicit parent forms an ordered bake-time fallback chain, while a bare non-first language falls back to the first language. | [Source/Common/TextPack.cpp](https://github.com/cvet/fonline/blob/master/Source/Common/TextPack.cpp), [Source/Tests/Test_TextPack.cpp](https://github.com/cvet/fonline/blob/master/Source/Tests/Test_TextPack.cpp) |
