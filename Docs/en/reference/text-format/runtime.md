...
| --- | --- | --- | --- | --- | --- |
| <a id="entry-text-format-runtime-get-language-3fe5c8a9cf"></a><code>text-format.runtime.get-language</code> | <code>LanguageName Game.GetLanguage()</code> | <code>server</code>, <code>client</code>, <code>mapper</code> | Returns the engine instance's current language as a strong LanguageName wrapper; the configured Client.Language value is only the startup default. | Not applicable. | [Source/Scripting/CommonGlobalScriptMethods.cpp](https://github.com/cvet/fonline/blob/master/Source/Scripting/CommonGlobalScriptMethods.cpp) |
...
| <a id="entry-text-format-runtime-change-language-f4b573ddec"></a><code>text-format.runtime.change-language</code> | <code>void Game.ChangeLanguage(string langName)</code> | <code>client</code>, <code>mapper</code> | Loads langName into the current client pack and updates the engine-owned current-language state without mutating the configured Client.Language setting. | The Engine does not validate the identifier, apply another fallback, or invoke a project GUI refresh callback. | [Source/Scripting/ClientGlobalScriptMethods.cpp](https://github.com/cvet/fonline/blob/master/Source/Scripting/ClientGlobalScriptMethods.cpp), [Source/Client/Client.cpp](https://github.com/cvet/fonline/blob/master/Source/Client/Client.cpp) |
| <a id="entry-text-format-runtime-server-boundary-2b4580120e"></a><code>text-format.runtime.server-boundary</code> | <code>server: IsTextPresent and GetTextCount only</code> | <code>server</code> | The server loads one pack from the configured Client.Language startup value and exposes presence and count queries. | There is no server script Game.GetText overload in the Engine API. | [Source/Server/Server.cpp](https://github.com/cvet/fonline/blob/master/Source/Server/Server.cpp), [Source/Scripting/ServerGlobalScriptMethods.cpp](https://github.com/cvet/fonline/blob/master/Source/Scripting/ServerGlobalScriptMethods.cpp) |
