...
permalink: /Docs/en/contributing/coding-contracts/smart-pointers.html
---
...
12. Do not reintroduce the removed permissive `FO_STRICT_*` modes. When integrating an older branch, migrate optional state to the nullable wrappers before adopting the current header.
