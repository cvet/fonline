...
<!-- docs-translation: {"document_id":"generated-model-format-composition","locale":"ru","source_path":"Docs/en/reference/model-format/composition.md","source_sha256":"353dd2ddd570373545e09c3cda3659f71ba86bdcc28ad66ca30d4f74b358c102"} -->
...
| <code>Attach</code> | <code>selected Layer/Value</code> | Создаёт layer-selected child-model link. Path относителен к файлу с directive. | С Link child присоединяется к одной parent bone; без него одноимённые child/parent bones образуют shared-skeleton attachment. | [Source/Tools/ModelInfoBaker.cpp](https://github.com/cvet/fonline/blob/master/Source/Tools/ModelInfoBaker.cpp), [Source/Client/ModelInstance.cpp](https://github.com/cvet/fonline/blob/master/Source/Client/ModelInstance.cpp) |
