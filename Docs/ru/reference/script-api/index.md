...
<!-- docs-translation: {"document_id":"generated-api-index","locale":"ru","source_path":"Docs/en/reference/script-api/index.md","source_sha256":"23143aa9870f192b902daeba6827b2e529a849220eb308d0bf50040c7337008e"} -->
...
| --- | --- | --- |
| [Нативные методы скриптов](methods.md) | 989 | Нативные методы, экспортированные в скрипты. |
...
| Сигнал | Количество |
| --- | --- |
| Адресуемые символы | 2529 |
| Символы с описаниями | 2529 |
...
Полный текущий инвентарь имеет статус <code>experimental</code> с версии <code>2022.1.0.wip</code>. Объявление закрепляет 2529 стабильных ID хешем SHA-256 <code>621bafec6aee07ca2da7468ef223875bd22ab7d9baedfc9dcf430e7765dbc7c4</code>; любое добавление или удаление символа либо изменение стабильного ID останавливает генерацию, пока владелец не проверит и не обновит оба пина.
