...
<!-- docs-translation: {"document_id":"generated-api-index","locale":"ru","source_path":"Docs/en/reference/script-api/index.md","source_sha256":"87413dedb17d0dda1d4aabbe5ffeea1f9f26fed0a013e42754855e65d3cdd328"} -->
...
| Сигнал | Количество |
| --- | --- |
| Адресуемые символы | 2530 |
| Символы с описаниями | 2530 |
...
Полный текущий инвентарь имеет статус <code>experimental</code> с версии <code>2022.1.0.wip</code>. Объявление закрепляет 2530 стабильных ID хешем SHA-256 <code>e7d48961fd1ed4025d05559208ee49db3fda8ba32bf613ceb1af8d6807bfcc43</code>; любое добавление или удаление символа либо изменение стабильного ID останавливает генерацию, пока владелец не проверит и не обновит оба пина.
