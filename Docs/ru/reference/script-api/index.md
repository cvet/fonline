...
<!-- docs-translation: {"document_id":"generated-api-index","locale":"ru","source_path":"Docs/en/reference/script-api/index.md","source_sha256":"3c8f0390f41bb6065d025b58e28d7fd8b82623cf5b6adc643b1c3552ba855995"} -->
...
| [Настройки движка](settings.md) | 266 | Настройки движка только для чтения, сгруппированные по областям. |
...
| Сигнал | Количество |
| --- | --- |
| Адресуемые символы | 2532 |
| Символы с описаниями | 2532 |
...
Полный текущий инвентарь имеет статус <code>experimental</code> с версии <code>2022.1.0.wip</code>. Объявление закрепляет 2532 стабильных ID хешем SHA-256 <code>7c6b1ce985128b9da3be5ce578458d68584b9e95ec09f613b46431fa4a40d136</code>; любое добавление или удаление символа либо изменение стабильного ID останавливает генерацию, пока владелец не проверит и не обновит оба пина.
