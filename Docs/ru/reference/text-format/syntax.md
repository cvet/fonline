...
<!-- docs-translation: {"document_id":"generated-text-format-syntax","locale":"ru","source_path":"Docs/en/reference/text-format/syntax.md","source_sha256":"dcc307971eedf383d05cfb87edd2e0e1e6432e7ef68c55327c517e575446258d"} -->
...
| <a id="entry-text-format-syntax-variants-a3b452dc5d"></a><code>text-format.syntax.variants</code> | Варианты повторяющегося ключа | Несколько записей могут использовать один полный TextPackKey и оставаться упорядоченными вариантами в запечённом multimap. | Количество вариантов и выбор по индексу являются явными runtime-операциями; нормализация языков не выравнивает количество дубликатов. | [Source/Common/TextPack.h](https://github.com/cvet/fonline/blob/master/Source/Common/TextPack.h), [Source/Tests/Test_TextPack.cpp](https://github.com/cvet/fonline/blob/master/Source/Tests/Test_TextPack.cpp) |
