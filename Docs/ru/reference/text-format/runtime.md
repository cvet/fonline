...
<!-- docs-translation: {"document_id":"generated-text-format-runtime","locale":"ru","source_path":"Docs/en/reference/text-format/runtime.md","source_sha256":"6e6491b9895bb42d9ef66e4ea597a29b1399d8a94d8abe712ab052340e6e5c8a"} -->
...
| --- | --- | --- | --- | --- | --- |
| <a id="entry-text-format-runtime-get-language-3fe5c8a9cf"></a><code>text-format.runtime.get-language</code> | <code>LanguageName Game.GetLanguage()</code> | <code>server</code>, <code>client</code>, <code>mapper</code> | Возвращает текущий язык экземпляра движка в строгой обёртке LanguageName; настроенное значение Client.Language служит только стартовым значением. | Неприменимо. | [Source/Scripting/CommonGlobalScriptMethods.cpp](https://github.com/cvet/fonline/blob/master/Source/Scripting/CommonGlobalScriptMethods.cpp) |
