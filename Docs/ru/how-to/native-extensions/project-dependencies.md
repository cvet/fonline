...
<!-- docs-translation: {"document_id":"project-local-dependencies","locale":"ru","source_path":"Docs/en/how-to/native-extensions/project-dependencies.md","source_sha256":"2062a10908b13e067c7fb83accd407bcd6167a371556b32fe1be35c80c994d6b"} -->
...
3. Создайте проектную цель после появления third-party targets Engine и до того,
   как `BuildCoreLibraries()` потребит привязанные к ревизии списки библиотек.
   Добавляйте её только в необходимые `FO_COMMON_LIBS`, `FO_SERVER_LIBS`,
   `FO_CLIENT_LIBS`, `FO_BAKER_LIBS` или `FO_TESTING_LIBS`.
