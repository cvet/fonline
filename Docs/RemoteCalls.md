...
Malformed or tampered payloads still pass through engine decoding checks, but transport decoding does not replace domain validation. Log failures with enough call/caller context to diagnose them without logging secrets or full untrusted payloads.
...
- [Scripting.md](Scripting.md) - scripting runtime and callback ownership.
- [Nullability.md](Nullability.md) - script nullability and remote-call signature matching.
- [GeneratedApiAndMetadata.md](GeneratedApiAndMetadata.md) - codegen versus baked metadata ownership.
- [Networking.md](Networking.md) - transport and connection model.
- [BakingPipeline.md](BakingPipeline.md) - resource-pack and baker execution.
