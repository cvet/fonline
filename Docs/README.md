...
- [ClientMultithreading.md](ClientMultithreading.md) — the runtime `Client.WorkerThreads` option: the work scheduler, the two-phase sprite update, model pose phases, ownership boundaries, platform support, and the measurement contract.
