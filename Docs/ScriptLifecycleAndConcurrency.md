...
- [Scripting.md](Scripting.md) for the complete scripting subsystem and native binding path.
- [EntityModel.md](EntityModel.md) for entity, property, holder, and destruction ownership.
- [ServerRuntime.md](ServerRuntime.md) and [ClientRuntime.md](ClientRuntime.md) for side-specific loops and managers.
- [RemoteCalls.md](RemoteCalls.md) for network entry points and authority boundaries.
...
- remote-call handlers belong to the remote-call dispatcher described in [RemoteCalls.md](RemoteCalls.md);
...
For all engine documentation changes, also run the standalone documentation gate from [DocumentationMaintenance.md](DocumentationMaintenance.md).
