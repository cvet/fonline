...
[Index](index.md) | [Syntax](syntax.md) | [Languages](languages.md) | [Prototype text](proto-text.md) | [Runtime](runtime.md) | [Validation](validation.md) | [Canonical JSON](../text-format.json) | [Guide](../../TextAndLocalization.md)
...
| <a id="entry-text-format-syntax-variants-a3b452dc5d"></a><code>text-format.syntax.variants</code> | Duplicate-key variants | Multiple entries may share the same complete TextPackKey and remain ordered variants in the baked multimap. | Variant count and indexed selection are explicit runtime operations; duplicate cardinality is not language-normalized. | [Source/Common/TextPack.h](https://github.com/cvet/fonline/blob/master/Source/Common/TextPack.h), [Source/Tests/Test_TextPack.cpp](https://github.com/cvet/fonline/blob/master/Source/Tests/Test_TextPack.cpp) |
