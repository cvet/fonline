...
usage: package.py [-h] -maincfg MAINCFG -buildhash BUILDHASH -devname DEVNAME
                  -nicename NICENAME
                  -target {Server,Client,Editor,Mapper,Baker}
...
| <a id="entry-package-cli-argument-target-3abbb688eb"></a><code>package.cli.argument.target</code> | <code>-target</code> | yes | <code>store</code> | <code>Server</code>, <code>Client</code>, <code>Editor</code>, <code>Mapper</code>, <code>Baker</code> | - | package target type |
