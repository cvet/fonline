...
The section selects the type. The extension and directory do not. Values use the shared configuration parser, including `#` comments, backslash continuation, and `key += value` append syntax.
