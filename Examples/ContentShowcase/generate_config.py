...
OUTPUT_PATH = PROJECT_ROOT / "FOnlineContentShowcase.fomain"

OVERRIDES = {
    "Common.GameName": "FOnline Content Showcase",
    ...
    "Server.EntityStartId": "11000000001",
    ...
    "Baking.ClientResources": "Resources-Baked",
    ...
    "Web.AspectFactor": "0.625f",
    "Render.WindowResizable": "False",
    "Render.FixedFPS": "60",
    "Render.ImGuiDefaultEffect": "Effects/ImGui_Default.fofx",
}

PROJECT_SECTIONS = """
# Showcase-owned settings
Showcase.Automation = False
Showcase.ContentTest = False
Showcase.Capture = False

[SubConfig]
Name = ShowcaseRelease

[SubConfig]
Name = ShowcaseContentTest
Showcase.ContentTest = True
ServerNetwork.DisableNetworking = True

[SubConfig]
Name = ShowcaseSmoke
Showcase.Automation = True
...
[SubConfig]
Name = ShowcaseCapture
Showcase.Automation = True
Showcase.Capture = True
Baking.IgnoreMissingBakerWarning = True
Render.ForceDirect3D = True
Render.FixedFPS = 60
View.ScreenWidth = 1280
View.ScreenHeight = 800

[SubConfig]
Name = ShowcaseCaptureOpenGL
Showcase.Automation = True
Showcase.Capture = True
Baking.IgnoreMissingBakerWarning = True
Render.ForceOpenGL = True
Render.FixedFPS = 60
View.ScreenWidth = 1280
View.ScreenHeight = 800
...
IncludePatterns = Showcase.fos Core.fos
Bakers = AngelScript
...
[ResourcePack]
Name = ShowcaseResources
InputDirs = ShowcaseAssets
IncludePatterns = **
Bakers = Image Effect Particle RawCopy
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Generate the full Content Showcase runtime config.")
    ...
    if args.check:
        if current != rendered:
            ...
            return 1
        print(f"Content Showcase config is current: {OUTPUT_PATH}")
        return 0
