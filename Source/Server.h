...
//	void GlobalEventCritterDead(Critter* cr);
    ...
    struct SScriptFunc
    {
        ...
        static uint  Container_GetItems( Item* cont, uint stack_id, CScriptArray* items );
		...
		static ScriptString* Crit_GetLexems( Critter* cr );
        ...
        static uint       Map_GetMObjectsHexEx( Map* map, ushort hx, ushort hy, uint radius, ushort pid, CScriptArray* sceneries );
		static uint       Map_GetWalls( Map* map, ushort hexX, ushort hexY, CScriptArray* sceneries );
		static uint       Map_GetSceneryClients( Map* map, ushort hexX, ushort hexY, CScriptArray* sceneries );
        ...
        static uint          Global_CreateTimeEventValues( uint begin_second, ScriptString& script_name, CScriptArray& values, bool save );
        ...
        static bool          Global_SetAnyData( ScriptString& name, CScriptArray& data );
        static bool          Global_SetAnyDataSize( ScriptString& name, CScriptArray& data, uint data_size_bytes );
        static bool          Global_GetAnyData( ScriptString& name, CScriptArray& data );
