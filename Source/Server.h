...
public:
    ...
    struct SScriptFunc
    {
        ...
        static void          Crit_Say( Critter* cr, uchar how_say, const string& text );
        static void          Crit_SayMsg( Critter* cr, uchar how_say, ushort text_msg, uint num_str );
        static void          Crit_SayMsgLex( Critter* cr, uchar how_say, ushort text_msg, uint num_str, const string& lexems );
        ...
        static void Crit_PlaySound( Critter* cr, const string& sound_name, bool send_self );
        ...
        static void          Map_SetText( Map* map, ushort hex_x, ushort hex_y, uint color, const string& text );
        static void          Map_SetTextMsg( Map* map, ushort hex_x, ushort hex_y, uint color, ushort text_msg, uint str_num );
        static void          Map_SetTextMsgLex( Map* map, ushort hex_x, ushort hex_y, uint color, ushort text_msg, uint str_num, const string& lexems );
        ...
        static void          Map_PlaySound( Map* map, const string& sound_name );
        static void          Map_PlaySoundRadius( Map* map, const string& sound_name, ushort hx, ushort hy, uint radius );
        ...
        static void          Global_RadioMessage( ushort channel, const string& text );
        static void          Global_RadioMessageMsg( ushort channel, ushort text_msg, uint num_str );
        static void          Global_RadioMessageMsgLex( ushort channel, ushort text_msg, uint num_str, const string& lexems );
        ...
        static Critter*      Global_GetPlayer( const string& name );
        static uint          Global_GetPlayerId( const string& name );
        ...
        static bool          Global_AddTextListener( int say_type, const string& first_str, uint parameter, asIScriptFunction* func );
        static void          Global_EraseTextListener( int say_type, const string& first_str, uint parameter );
        ...
        static bool Global_LoadImage( uint index, const string& image_name, uint image_depth );
        static uint Global_GetImageColor( uint index, uint x, uint y );
        static void Global_YieldWebRequest( const string& url, CScriptDict* post, bool& success, string& result );
    } ScriptFunc;
};
