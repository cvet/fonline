...
/************************************************************************/
    ...
    struct SScriptFunc
    {
        ...
        static string        Global_CustomCall( const string& command, const string& separator );
        ...
        static bool          Global_PlaySound( const string& sound_name );
        static bool          Global_PlayMusic( const string& music_name, uint pos, uint repeat );
        static void          Global_PlayVideo( const string& video_name, bool can_stop );

        static hash   Global_GetCurrentMapPid();
        static void   Global_Message( const string& msg );
        static void   Global_MessageType( const string& msg, int type );
        ...
        static void   Global_MapMessage( const string& text, ushort hx, ushort hy, uint ms, uint color, bool fade, int ox, int oy );
        ...
        static string Global_ReplaceTextStr( const string& text, const string& replace, const string& str );
        static string Global_ReplaceTextInt( const string& text, const string& replace, int i );
        static string Global_FormatTags( const string& text, const string& lexems );
        ...
        static bool Global_LoadDataFile( const string& dat_name );

        static uint Global_LoadSprite( const string& spr_name );
        ...
        static void Global_GetTextInfo( const string& text, int w, int h, int font, int flags, int& tw, int& th, int& lines );
        ...
        static void Global_DrawText( const string& text, int x, int y, int w, int h, uint color, int font, int flags );
        ...
        static bool          Global_LoadFont( int font, const string& font_fname );
        static void          Global_SetDefaultFont( int font, uint color );
        static bool          Global_SetEffect( int effect_type, int effect_subtype, const string& effect_name, const string& effect_defines );
        ...
        static void          Global_KeyboardPress( uchar key1, uchar key2, const string& key1_text, const string& key2_text );
        static void          Global_SetRainAnimation( const string& fall_anim_name, const string& drop_anim_name );
        static void          Global_ChangeZoom( float target_zoom );
        static bool          Global_SaveScreenshot( const string& file_path );
        static bool          Global_SaveText( const string& file_path, const string& text );
        static void          Global_SetCacheData( const string& name, const CScriptArray* data );
        static void          Global_SetCacheDataSize( const string& name, const CScriptArray* data, uint data_size );
        static CScriptArray* Global_GetCacheData( const string& name );
        static void          Global_SetCacheDataStr( const string& name, const string& str );
        static string        Global_GetCacheDataStr( const string& name );
        static bool          Global_IsCacheData( const string& name );
        static void          Global_EraseCacheData( const string& name );
