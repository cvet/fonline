...
int OptMsgboxInvert;
int OptChangeLang;
int OptDefaultCombatMode;
int OptMessNotify;
int OptSoundNotify;
int OptAlwaysOnTop;
int OptTextDelay;
int OptDamageHitDelay;
int OptScreenWidth;
int OptScreenHeight;
int OptMultiSampling;
int OptSoftwareSkinning;
int OptMouseScroll;
int OptIndicatorType;
int OptDoubleClickTime;
int OptRoofAlpha;
int OptHideCursor;
int OptDisableLMenu;
int OptDisableMouseEvents;
int OptDisableKeyboardEvents;
int OptPlayerOffAppendix;
int OptCombatMessagesType;
int OptFixedZ;
int SpritesZoom;
int SpritesZoomMax;
int SpritesZoomMin;
