...
- `Test_RemoteCallValidation.cpp` — inbound remote-call payload validation for UTF-8 strings, enum values, finite floats, hashes, nested collections, and layout-backed `RefType` payloads
