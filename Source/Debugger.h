...
#ifdef MEMORY_DEBUG
#define MEMORY_PROCESS(block,memory) if(MemoryDebugLevel>=1) Debugger::Memory(block,memory)
#define MEMORY_PROCESS_STR(block,memory) if(MemoryDebugLevel>=2) Debugger::MemoryStr(block,memory)
#else
...
#define MEMORY_SCRIPT_STRING (12)
#define MEMORY_ANGEL_SCRIPT  (13)
