...
/*class ScriptJson
   ...
   public:
    ...
    ScriptJson( const nlohmann::json& other )
    {
        json = other;
        refCount = 1;
    }
   ...
   ++refCount;
    ...
    static ScriptJson* FabricNull()
    {
        return new ScriptJson( nullptr );
    }

    static ScriptJson* FabricInt( int value )
    {
        return new ScriptJson( value );
    }

    static ScriptJson* FabricFloat( float value )
    {
        return new ScriptJson( value );
    }

    static ScriptJson* FabricString( const string& value )
    {
        return new ScriptJson( value );
    }

    static ScriptJson* FabricBool( bool value )
    {
        return new ScriptJson( value );
    }

    static ScriptJson* FabricArray( CScriptArray* value )
    {
        return new ScriptJson( value );
    }

    static ScriptJson* FabricObject( CScriptDict* value )
    {
        return new ScriptJson( value );
    }

    bool IsInt()    { return json.is_number_integer(); }
    bool IsFloat()  { return json.is_number_float(); }
    bool IsString() { return json.is_string(); }
    bool IsBool()   { return json.is_boolean(); }
    bool IsArray()  { return json.is_array(); }
    bool IsObject() { return json.is_object(); }
    bool IsNull()   { return json.is_null(); }

    int    AsInt()    { return json.is_number_integer() ? (int) json : 0; }
    float  AsFloat()  { return json.is_number_float() ? (float) json : 0.0f; }
    string AsString() { return json.is_string() ? (string) json : string(); }
    bool   AsBool()   { return json.is_boolean() ? (bool) json : false; }

    CScriptArray* AsArray()
    {
        CScriptArray* arr = Script::CreateArray( "json[]" );
        if( !json.is_array() )
            return arr;

        for( nlohmann::json& child : json )
        {
            ScriptJson* script_child = new ScriptJson( child );
            arr->InsertLast( script_child );
            script_child->Release();
        }

        return arr;
    }

    CScriptDict* AsObject()
    {
        asITypeInfo* ti = Script::GetEngine()->GetTypeInfoByDecl( "dict<string,json>" );
        CScriptDict* dict = CScriptDict::Create( ti );
        if( !json.is_object() )
            return dict;
        ...
        for( nlohmann::json::iterator it = json.begin(); it != json.end(); ++it )
        {
            ...
            ScriptJson*           script_value = new ScriptJson( value );
            dict->Set( (void*) &key, script_value );
        }
   ...
   void Script::RegisterScriptJson( asIScriptEngine* engine )
   {
    int r = engine->RegisterObjectType( "json", sizeof( ScriptJson ), asOBJ_REF );
    RUNTIME_ASSERT( r >= 0 );

    r = engine->RegisterObjectBehaviour( "json", asBEHAVE_FACTORY, "json@ f()", SCRIPT_FUNC( ScriptJson::FabricNull ), SCRIPT_FUNC_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectBehaviour( "json", asBEHAVE_FACTORY, "json@ f(int)", SCRIPT_FUNC( ScriptJson::FabricInt ), SCRIPT_FUNC_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectBehaviour( "json", asBEHAVE_FACTORY, "json@ f(float)", SCRIPT_FUNC( ScriptJson::FabricFloat ), SCRIPT_FUNC_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectBehaviour( "json", asBEHAVE_FACTORY, "json@ f(const string&)", SCRIPT_FUNC( ScriptJson::FabricString ), SCRIPT_FUNC_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectBehaviour( "json", asBEHAVE_FACTORY, "json@ f(bool)", SCRIPT_FUNC( ScriptJson::FabricBool ), SCRIPT_FUNC_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectBehaviour( "json", asBEHAVE_FACTORY, "json@ f(array<json@>@)", SCRIPT_FUNC( ScriptJson::FabricArray ), SCRIPT_FUNC_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectBehaviour( "json", asBEHAVE_FACTORY, "json@ f(dict<string, json@>@)", SCRIPT_FUNC( ScriptJson::FabricObject ), SCRIPT_FUNC_CONV );
    RUNTIME_ASSERT( r >= 0 );

    r = engine->RegisterObjectMethod( "json", "bool isInt() const", SCRIPT_METHOD( ScriptJson, IsInt ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "bool isFloat() const", SCRIPT_METHOD( ScriptJson, IsFloat ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "bool isString() const", SCRIPT_METHOD( ScriptJson, IsString ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "bool isBool() const", SCRIPT_METHOD( ScriptJson, IsBool ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "bool isArray() const", SCRIPT_METHOD( ScriptJson, IsArray ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "bool isObject() const", SCRIPT_METHOD( ScriptJson, IsObject ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "bool isNull() const", SCRIPT_METHOD( ScriptJson, IsNull ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );

    r = engine->RegisterObjectMethod( "json", "int asInt() const", SCRIPT_METHOD( ScriptJson, AsInt ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "float asFloat() const", SCRIPT_METHOD( ScriptJson, AsFloat ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "string asString() const", SCRIPT_METHOD( ScriptJson, AsString ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "bool asBool() const", SCRIPT_METHOD( ScriptJson, AsBool ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "array<json@> asArray() const", SCRIPT_METHOD( ScriptJson, AsArray ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
    r = engine->RegisterObjectMethod( "json", "dict<string, json@> asObject() const", SCRIPT_METHOD( ScriptJson, AsObject ), SCRIPT_METHOD_CONV );
    RUNTIME_ASSERT( r >= 0 );
   }*/
