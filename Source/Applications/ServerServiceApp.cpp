...
#endif
{
    ...
    else
    {
        ...
        if( service )
        {
            ...
            {
                if( !ChangeServiceConfigW( service, SERVICE_NO_CHANGE, SERVICE_NO_CHANGE, SERVICE_NO_CHANGE, _str( path ).toWideChar().c_str(), nullptr, nullptr, nullptr, nullptr, nullptr, nullptr ) )
                    error = true;
            }
            free( service_cfg );
        }
