...
#define BANS_FNAME_EXPIRED "Save/Bans/Expired.txt"
    ...
    struct ScriptFunc
    {
        ...
        static bool Crit_AddTimeEventRate(
            Critter* cr, asIScriptFunction* func, uint duration, int identifier, uint rate);
        static uint Crit_GetTimeEvents(
            Critter* cr, int identifier, CScriptArray* indexes, CScriptArray* durations, CScriptArray* rates);
        static uint Crit_GetTimeEventsArr(Critter* cr, CScriptArray* find_identifiers, CScriptArray* identifiers,
        ...
        static CScriptArray* Map_GetItemsHexRadiusPredicate(
        ...
        static CScriptArray* Map_GetCrittersInPath(Map* map, ushort from_hx, ushort from_hy, ushort to_hx, ushort to_hy,
            float angle, uint dist, int find_type);
        static CScriptArray* Map_GetCrittersInPathBlock(Map* map, ushort from_hx, ushort from_hy, ushort to_hx,
            ushort to_hy, float angle, uint dist, int find_type, ushort& pre_block_hx, ushort& pre_block_hy,
            ushort& block_hx, ushort& block_hy);
        static CScriptArray* Map_GetCrittersWhoViewPath(
        ...
        static void Map_GetHexInPathWall(
            Map* map, ushort from_hx, ushort from_hy, ushort& to_hx, ushort& to_hy, float angle, uint dist);
        static uint Map_GetPathLengthHex(
        ...
        static void Map_RunFlyEffect(Map* map, hash eff_pid, Critter* from_cr, Critter* to_cr, ushort from_hx,
