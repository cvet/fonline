...
public:
    ...
    struct SScriptFunc
    {
        ...
        static void   Global_AddTileName( ushort hx, ushort hy, int ox, int oy, int layer, bool roof, const string& pic_name );

        static void          Global_AllowSlot( uchar index, bool enable_send );
        static ProtoMap*     Global_LoadMap( const string& file_name );
        static void          Global_UnloadMap( ProtoMap* pmap );
        static bool          Global_SaveMap( ProtoMap* pmap, const string& custom_name );
        static bool          Global_ShowMap( ProtoMap* pmap );
        static CScriptArray* Global_GetLoadedMaps( int& index );
        static CScriptArray* Global_GetMapFileNames( const string& dir );
        ...
        static uint Global_TabGetItemPids( int tab, const string& sub_tab, CScriptArray* item_pids );
        static uint Global_TabGetCritterPids( int tab, const string& sub_tab, CScriptArray* critter_pids );
        static void Global_TabSetTileDirs( int tab, CScriptArray* dir_names, CScriptArray* include_subdirs );
        static void Global_TabSetItemPids( int tab, const string& sub_tab, CScriptArray* item_pids );
        static void Global_TabSetCritterPids( int tab, const string& sub_tab, CScriptArray* critter_pids );
        static void Global_TabDelete( int tab );
        static void Global_TabSelect( int tab, const string& sub_tab, bool show );
        static void Global_TabSetName( int tab, const string& tab_name );
        ...
        static string Global_GetIfaceIniStr( const string& key );
