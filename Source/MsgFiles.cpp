...
void FOMsg::AddStr(uint num, const char* str)
{
	...
	if(!str || !Str::Length(str)) strData.insert(UIntStrMulMapVal(num," "));
...
{
	if(Str::CompareCase(type_name,"text")) return TEXTMSG_TEXT;
	else if(Str::CompareCase(type_name,"dlg")) return TEXTMSG_DLG;
	else if(Str::CompareCase(type_name,"item")) return TEXTMSG_ITEM;
	else if(Str::CompareCase(type_name,"obj")) return TEXTMSG_ITEM;
	else if(Str::CompareCase(type_name,"game")) return TEXTMSG_GAME;
	else if(Str::CompareCase(type_name,"gm")) return TEXTMSG_GM;
	else if(Str::CompareCase(type_name,"combat")) return TEXTMSG_COMBAT;
	else if(Str::CompareCase(type_name,"quest")) return TEXTMSG_QUEST;
	else if(Str::CompareCase(type_name,"holo")) return TEXTMSG_HOLO;
	else if(Str::CompareCase(type_name,"craft")) return TEXTMSG_CRAFT;
	else if(Str::CompareCase(type_name,"fix")) return TEXTMSG_CRAFT;
	else if(Str::CompareCase(type_name,"internal")) return TEXTMSG_INTERNAL;
	return -1;
}
