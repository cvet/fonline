...
#define NETMSG_CRITTER_ITEM_POD_PROPERTY( b )         MAKE_NETMSG_HEADER( 180 + ( b ) )
#define NETMSG_CRITTER_ITEM_POD_PROPERTY_SIZE( b )    ( sizeof( uint ) * 2 + sizeof( ushort ) + ( b ) )
// ////////////////////////////////////////////////////////////////////////
// Item data changed
// uint crid
// uint item_id
...
#define NETMSG_CRITTER_ITEM_COMPLEX_PROPERTY    MAKE_NETMSG_HEADER( 189 )
// ////////////////////////////////////////////////////////////////////////
// Item data changed
// uint msg_len
// uint crid
...
#define NETMSG_MAP_ITEM_POD_PROPERTY( b )             MAKE_NETMSG_HEADER( 190 + ( b ) )
#define NETMSG_MAP_ITEM_POD_PROPERTY_SIZE( b )        ( sizeof( uint ) + sizeof( ushort ) + ( b ) )
// ////////////////////////////////////////////////////////////////////////
// Item data changed
// Params:
// uint item_id
...
#define NETMSG_MAP_ITEM_COMPLEX_PROPERTY        MAKE_NETMSG_HEADER( 199 )
// ////////////////////////////////////////////////////////////////////////
// Item data changed
// uint msg_len
// uint item_id
