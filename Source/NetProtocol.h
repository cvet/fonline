...
#define FO_PROTOCOL_VERSION		    (0xF0B1) // FOnline Protocol Version
...
MAX_NAME*2+sizeof(uint)+sizeof(uint)*10/*MSG*/+sizeof(uint)*13/*Proto*/+sizeof(uchar))
//////////////////////////////////////////////////////////////////////////
// Enter to game
// Params:
...
#define NETMSG_MSG_SIZE             (sizeof(uint)+sizeof(uint)+\
...
#define NETMSG_MAP_TEXT_MSG_SIZE    (sizeof(uint)+sizeof(ushort)*2+\
...
#define NETMSG_CRITTER_XY_SIZE      (sizeof(uint)+sizeof(uint)+\
...
#define NETMSG_ADD_ITEM_SIZE      (sizeof(uint)+sizeof(uint)+\
...
#define NETMSG_ADD_ITEM_ON_MAP_SIZE (sizeof(uint)+sizeof(uint)+\
...
#define NETMSG_SEND_CHANGE_ITEM_SIZE (sizeof(uint)+sizeof(uchar)+sizeof(uint)+sizeof(uchar)*2+\
sizeof(uint))
//////////////////////////////////////////////////////////////////////////
//
// Params:
...
#define NETMSG_SEND_ITEM_CONT_SIZE  (sizeof(uint)+sizeof(uchar)+sizeof(uint)*2+\
...
#define NETMSG_SEND_USE_ITEM_SIZE   (sizeof(uint)+sizeof(uchar)+sizeof(uint)+\
...
#define NETMSG_SEND_USE_SKILL_SIZE	(sizeof(uint)+sizeof(ushort)+sizeof(uchar)+\
...
#define NETMSG_SOME_ITEM_SIZE      (sizeof(uint)+sizeof(uint)+sizeof(ushort)+\
...
#define NETMSG_CRITTER_ACTION_SIZE	(sizeof(uint)+sizeof(uint)+\
...
#define NETMSG_CRITTER_KNOCKOUT_SIZE (sizeof(uint)+sizeof(uint)+\
...
#define NETMSG_CRITTER_ITEM_DATA_SIZE (sizeof(uint)+sizeof(uint)+\
sizeof(uchar)+92/*ItemData*/)
//////////////////////////////////////////////////////////////////////////
// Item data changed
// uint crid
...
#define NETMSG_CRITTER_ANIMATE_SIZE	(sizeof(uint)+sizeof(uint)*3+\
...
#define NETMSG_FLY_EFFECT_SIZE		(sizeof(uint)+sizeof(ushort)+\
...
#define NETMSG_PLAY_SOUND_SIZE      (sizeof(uint)+sizeof(uint)+16)
//////////////////////////////////////////////////////////////////////////
//
// Params:
...
#define NETMSG_SEND_TALK_NPC_SIZE	(sizeof(uint)+sizeof(uchar)+\
sizeof(uint)+sizeof(uchar))
//////////////////////////////////////////////////////////////////////////
...
#define NETMSG_SEND_SAY_NPC_SIZE    (sizeof(uint)+sizeof(uchar)+\
...
#define NETMSG_PLAYERS_BARTER_SIZE  (sizeof(uint)+sizeof(uchar)+\
sizeof(uint)*2)
//////////////////////////////////////////////////////////////////////////
//
// uchar barter
...
#define NETMSG_PLAYERS_BARTER_SET_HIDE_SIZE (sizeof(uint)+sizeof(uint)+\
...
#define NETMSG_GAME_INFO_SIZE       (sizeof(uint)+sizeof(ushort)*8+\
...
#define NETMSG_LOADMAP_SIZE	        (sizeof(uint)+sizeof(ushort)+\
...
#define NETMSG_SEND_GIVE_MAP_SIZE   (sizeof(uint)+sizeof(bool)+sizeof(ushort)+\
...
#define NETMSG_SEND_RULE_GLOBAL_SIZE (sizeof(uint)+sizeof(uchar)+\
sizeof(uint)*2)
//////////////////////////////////////////////////////////////////////////
// управление группой
...
#define NETMSG_FOLLOW_SIZE          (sizeof(uint)+sizeof(uint)+\
sizeof(uchar)+sizeof(ushort)+sizeof(uint))
//////////////////////////////////////////////////////////////////////////
// uint follow_rule
