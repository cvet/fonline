...
// Radio
#define STR_RADIO_BROADCAST_BEGIN       (460)
#define STR_RADIO_BROADCAST_END         (461)
#define STR_RADIO_CHAN_CHANGED          (462)
#define STR_RADIO_NOITEM                (463)
#define STR_RADIO_NEED_CHARGE           (464)

// Barter
#define STR_BARTER_GOOD_OFFER           (470)
#define STR_BARTER_BAD_OFFER            (471)
#define STR_BARTER_OVERWEIGHT           (472)
#define STR_BARTER_OVERSIZE             (473)
#define STR_BARTER_SALE_ITEM_NOT_FOUND  (474)
#define STR_BARTER_BUY_ITEM_NOT_FOUND   (475)
#define STR_BARTER_NO_BARTER_NOW        (476)
#define STR_BARTER_NO_BARTER_MODE       (477)
#define STR_BARTER_DIALOGBOX            (480)
#define STR_BARTER_OPEN_MODE            (481)
#define STR_BARTER_HIDE_MODE            (482)
#define STR_BARTER_BEGIN_FAIL           (483)
#define STR_BARTER_BEGIN                (485)
#define STR_BARTER_READY_OFFER          (486)
...
#define STR_NPC_NAME_(num,pid)			((num)!=0?(num)*1000+100:STR_NPC_PROTO_NAME_(pid))
#define STR_NPC_NAME #(num,pid)			((num)!=0?(num)*1000+100:STR_NPC_PROTO_NAME(pid))
#define STR_NPC_AVATAR_(num)			((num)!=0?(num)*1000+110:0)
#define STR_NPC_AVATAR #(num)			((num)!=0?(num)*1000+110:0)
#define STR_NPC_INFO_LIFE #(num,pid)	((num)!=0?(num)*1000+200:STR_NPC_PROTO_DESC(pid))
#define STR_NPC_FULL_INFO_LIFE #(num,pid) ((num)!=0?(num)*1000+210:STR_NPC_PROTO_DESC(pid))
#define STR_NPC_INFO_KO #(num,pid)		((num)!=0?(num)*1000+220:STR_NPC_PROTO_DESC(pid))
#define STR_NPC_FULL_INFO_KO #(num,pid)	((num)!=0?(num)*1000+230:STR_NPC_PROTO_DESC(pid))
#define STR_NPC_INFO_DEAD #(num,pid)	((num)!=0?(num)*1000+240:STR_NPC_PROTO_DESC(pid))
#define STR_NPC_FULL_INFO_DEAD #(num,pid) ((num)!=0?(num)*1000+250:STR_NPC_PROTO_DESC(pid))
#define STR_NPC_INFO_CRITICAL_DEAD #(num,pid) ((num)!=0?(num)*1000+260:STR_NPC_PROTO_DESC(pid))
#define STR_NPC_FULL_INFO_CRITICAL_DEAD #(num,pid) ((num)!=0?(num)*1000+270:STR_NPC_PROTO_DESC(pid))
