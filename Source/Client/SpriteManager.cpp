...
AnyFrames* SpriteManager::LoadAnimation(
    const string& fname, bool use_dummy /* = false */, bool frm_anim_pix /* = false */)
{
...
AnyFrames* SpriteManager::LoadAnimationArt(const string& fname)
{
    ...
    for (int dir = 0; dir < DIRS_COUNT; dir++)
    {
        ...
        uint data_offset =
            sizeof(ArtHeader) + sizeof(ArtPalette) * palette_count + sizeof(ArtFrameInfo) * dir_count * frm_count;
