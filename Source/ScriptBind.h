...
BIND_ASSERT( engine->RegisterGlobalFunction( "void SetPropertyGetCallback(const string& className, const string& propertyName, const string& scriptFunc)", asFUNCTION( BIND_CLASS Global_SetPropertyGetCallback ), asCALL_CDECL ) );
BIND_ASSERT( engine->RegisterGlobalFunction( "void AddPropertySetCallback(const string& className, const string& propertyName, const string& scriptFunc)", asFUNCTION( BIND_CLASS Global_AddPropertySetCallback ), asCALL_CDECL ) );
