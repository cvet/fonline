...
BIND_ASSERT( engine->RegisterObjectMethod( "Critter", "array<Item@>@ GetItems(int slot)", asFUNCTION( BIND_CLASS Crit_GetItems ), asCALL_CDECL_OBJFIRST ) );
BIND_ASSERT( engine->RegisterObjectMethod( "Critter", "array<const Item@>@ GetItems(int slot) const", asFUNCTION( BIND_CLASS Crit_GetItems ), asCALL_CDECL_OBJFIRST ) );
...
BIND_ASSERT( engine->RegisterObjectMethod( "Map", "array<Item@>@ GetItems(hash protoId)", asFUNCTION( BIND_CLASS Map_GetItemsByPid ), asCALL_CDECL_OBJFIRST ) );
BIND_ASSERT( engine->RegisterObjectMethod( "Map", "array<const Item@>@ GetItems(hash protoId) const", asFUNCTION( BIND_CLASS Map_GetItemsByPid ), asCALL_CDECL_OBJFIRST ) );
