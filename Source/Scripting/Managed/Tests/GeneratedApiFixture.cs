...
namespace FOnline
{
    ...
    public enum CritterProperty { Strength = 7 }
    public enum TextPackName { Game }
    public readonly struct hstring
    {
        private readonly string text;
        public hstring(string text) { this.text = text; }
        public static hstring FromString(string text) => new hstring(text);
        public override string ToString() => text;
    }

    public partial struct timespan { public long value; public timespan(long value) { this.value = value; } }
    public partial struct synctime { public long value; public synctime(long value) { this.value = value; } }
    ...
    public partial struct frect { public float x, y, width, height; }
    public partial struct ipos { public int x, y; public ipos(int x, int y) { this.x = x; this.y = y; } }
    public partial struct fpos { public float x, y; public fpos(float x, float y) { this.x = x; this.y = y; } }
    public partial struct isize { public int width, height; }
    public partial struct fsize { public float width, height; }
    public partial struct irect { public int x, y, width, height; }
    public partial struct mpos { public short x, y; }
    public partial struct msize { public short width, height; }
